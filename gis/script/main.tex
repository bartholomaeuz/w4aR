...
\noindent 2015 Markus Dornhofer\\ % Copyright notice

\noindent \textsc{fh-joanneum.at/evu}\\ % URL

\noindent Die Unterlagen wurden f\"ur die Studenten und Studentinnen des Studiengangs Energie, Verkehr und Umweltmanagement an
der Fachhochschule Joanneum in Kapfenberg gemacht. \\ % License information

\noindent \textit{Ausgabe 1, M\"arz 2015} % Printing/edition date
...
\chapter{Einleitung}
Sehr viele Daten (oft wird von 80% gesprochen) haben einen r\"aumlichen Bezug. Ein Bild sagt mehr als tausend Worte. Meist wird GIS mit einem Computersystem gleichgesetzt.

\section{Kataster und Liegenschaftsverwaltung}
Im 19 Jahrhundert kam es zu einer Vermessung der Grundst\"ucke und es wurde ein Liegenschaftskataster erstellt. Damit konnten Fl\"achen einen Besitzer zugeordnert, was
f\"ur einer Grundsteuer notwendig war. Im 20 Jahrhundert wurden auch Fl\"achenwidmungen durchgef\"uhrt. 
\begin{figure}[h]
\centering
\includegraphics[scale=1.2]{gis-steiermark-kl}
\caption{Zonen}
\end{figure}
Mit dem Webtool von GIS Steiermark kann man einzele Grundst\"ucke suchen und die Grenzen einsehen.



\section{Navigation}
Neben der Autonavigation spielt GIS auch f\"ur die Schifffahrt eine gro{\ss}e Rolle. 
\begin{figure}[h]
\centering
\includegraphics[scale=1.0]{biograd2-small-1000px}
\caption{Seekarte}
\end{figure}
Mit Leuchtfeuer lassen sich die Position des Schiffes bestimmen und die Tiefenangaben sch\"utzen vor Unterwasserkollisionen 

\section{Biologie - Populationen}
Nat\"urlich spielt die Natur in der Tierwelt eine gro{\ss}e Rolle. Populationen k\"onnen auf der Karte besser beobachtet und erhoben werden.

\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{kegelrobben-2011}
\caption{Kegelrobben}
\end{figure}


\section{Statistische Daten}
Viele statistische Daten k\"onnen auch in ihrem Raumbezug dargestellt werden. Graphiken von Wahlen, Arbeitslosigkeit oder Einkommensverhältnissen finden sich oft in Zeitungen.  
\begin{figure}[h]
\centering
\includegraphics[scale=1.0]{stmk-bev13-30-kl}
...
Statt dem Vorzeichen wird oft auch die Himmelsrichtung (z.B. 47\degree30` N) verwendet.   
...
\begin{figure}[h]
\centering\includegraphics[scale=0.6]{vector-raster}
\caption{Shapefile}
\end{figure}
