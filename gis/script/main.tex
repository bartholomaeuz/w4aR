...
Statt dem Vorzeichen wird oft auch die Himmelsrichtung (z.B. 47\degree30` N) verwendet.   
 ...
 \begin{figure}
    \subfigure[Bezeichnung der linken Grafik]{\includegraphics[width=0.49\textwidth]{lat_long_globe}}
    \subfigure[Bezeichnung der rechten Grafik]{\includegraphics[width=0.49\textwidth]{Latitude_kl}}
