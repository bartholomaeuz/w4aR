...
\begin{figure}[h]
\centering\includegraphics[scale=2.0]{gis-steiermark-kl}
\caption{Zonen}
\end{figure}

\section{Biologie - Populationen}
\begin{figure}[h]
\centering\includegraphics[scale=1.0]{kegelrobben-2011}
\caption{Kegelrobben}
\end{figure}

\section{Navigation}
\begin{figure}[h]
\centering\includegraphics[scale=1.0]{biograd2-small-1000px}
\caption{Seekarte}
\end{figure}

\section{Bev\"olkerungsver\"anderung in der Steiermark}
\begin{figure}[h]
\centering\includegraphics[scale=2.0]{stmk-bev13-30-kl}
