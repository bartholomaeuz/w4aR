...
\begin{figure}
        \centering
        \subfigure[lat_lon]{\includegraphics[width=0.3\textwidth]{lat_long_globe}}
        \subfigure[lat]{ \includegraphics[width=0.3\textwidth]{Latitude_kl}}
       \subfigure[lon]{\includegraphics[width=0.3\textwidth]{Longitude_kl}}
