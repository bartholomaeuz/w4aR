...
\section{Position}
Grunds\"atzlich kann jede Position auf der Erde mit 2 verschiedenen Winkeln angegeben werden. Die Latidute ist der Winkel von Aquator zu den Polen.
...
\begin{figure}[h]
\centering\includegraphics[scale=1.0]{lat_long_globe}
\caption{Shapefile}
\end{figure}
