...
\begin{itemize}
  \item Is the routing service free of charge and is it possible to adopt it?
  \item What information is in the routing graph?
  
\begin{itemize}
Is the routing service free of charge and is it possible to adopt it for blind pedestrian routing? What additional information can be in the routing graph? Can it use OpenStreetMap data to generate the routing graph? The Web-Frontend is not required for the blind users, but it is important for the developer. It is easier to test different routes and it gives you a good impression about the output of the routing service. \\

What streets are preferred by blind persons? What solution is the best?
