...
\begin{description}
  \item highway=pedestrian, living_street, path, footway, steps, elevator
  \item surface=paved, unpaved, asphalt, concrete, concrete:plates, fine_gravel, metal, paving_stones
  \item footway=sidewalk, kerb, tactile_paving
  \item crossing, taffic_signals:sound  
\end{description}
