...
\title{Open Source pedestrian routing service with OpenStreetMap Data for blind people\titlenote{(Produces the permission block, and
...
Loadstone GPS:
The pioneer in free GPS navigation software is Loadstone GPS. It is running on Symbinan mobile phones and uses an external bluetooth GPS receiver. The product is very popular in the community of blind and visually impaired people.

Blindsquare:
Blindsquare is an Iphone App and uses point of interest information from foursquare and OpenStreetMap. The actual price is about US dollar 24. 

OSMAnd Maps and Navigation:

Weyrer (FH Kärnten): 
Timothy Weyrer wrote a master thesis about intermodal door-to-door application for people with disabilities on the carinthia university of applied sciences.

Sven Leitinger (SR):
Sven Leitinger from Salzburg Research wrote a guideline to enhance the OSM Data with blind related attibutes. He explained most of the OSM tag, which are useful for blind people. The work focus on existing OSM tags and are not creating new features. But no prioritisation of OSM tag had been made. 
...
https://github.com/opentripplanner/OpenTripPlanner/wiki/GraphStructure

http://localhost:8080/opentripplanner-api-webapp/ws/serverinfo
...
Citations to articles \cite{braams:babel, herlihy:methodology},
conference proceedings \cite{Rehrl:2010} or
